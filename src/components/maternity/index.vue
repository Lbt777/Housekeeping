...
<style lang="less" scoped>
  ...
  .month-nurse-module01{
    height: 380px;
  }
  .month-nurse-module01 ul{
    width: 924px;
    height: 198px;
   margin: 60px 0 50px 30px;
  }
  .month-nurse-module01 li{
      width: 198px;
      height: 198px;
      margin: 0 55px;
      padding: 20px;
  ...
  .month-nurse-module01 .li3{
    background: url("./img/mon-nurse3.jpg");
  }

  .nurse-btn{
    width: 200px;
    height: 35px;
    background-color: @grayorangeColor;
    color: #fff;
    text-align: center;
    line-height: 35px;
    font-size: 18px;
  ...
  .title i{
    background: url("./img/mon-bg1.png");
    display: block;
    width: 244px;
    height: 12px;
    margin: 0 auto 10px;
  ...
  .month-nurse-module02{
    height: 291px;
    .pub-color01{
      background:@lightorangeColor ;
    }
  }
  .month-nurse-module02 li i{
    font-family: MV Boli;
    font-size: 40px;
    font-style: normal;
...
.pub-color-blue{
  ...
  .fenge-line02{
    ...
    line-height: 30px;
    padding-left: 30px;
    background: @whiteColor url("./img/mon-icon.png") no-repeat 13px center;
    margin: 30px 0px;
  }
  .title1{
    background: @whiteColor;
 ...
 .contens-nurse li div {
    float: left;
    margin-left: 12px;
    width: 204px;
  }
  .contens-nurse li div b{
    float: right;
    color: #E95513;
    font-size: 16px;
  }
  .contens-nurse li div  h6{
    font-size: 16px;
    margin: 20px 0 10px;
    text-align: left;
  }
  .contens-nurse li div p {
    font-size: 12px;
    color: #666;
    line-height: 20px;
    text-align: left;
...
.nurse-bg-img{
  ...
  #word-line01,#word-line02,#word-line03{
    color: @grayorangeColor;
  }
  .nurse-cont hr{
    border-style: dashed;
